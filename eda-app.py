...
if algorithm == "Classification":
    ...
    clf_model, X_test, y_test, accuracy = train_classification_model(df, target_column, classification_model)
    save_model(clf_model)
    aslam = clf_model
    st.write('Accuracy Score = ',accuracy)
    st.write(f"Classification Model Trained Successfully and Saved as {nameofmodel}.pkl")
    ...
    reg_model, X_test, y_test, r2 = train_regression_model(df, target_column, regression_model)
